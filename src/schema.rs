...
/*
impl Clone for ColumnFile {
		fn clone(&self) -> Self {
			*self
		}

    fn clone_from(&mut self, source: &Self) { 
			self.path = PathBuf::from(source.path);
			self.file = File::from(source.file);
  ...
  pub fn new(name: &str, r#type: ColumnType) -> Column {
    Column {
      ...
      stride: match r#type {
        ...
        ColumnType::I32 | ColumnType::U32 => 4, ColumnType::F32 => 4,
        ColumnType::Timestamp |        ColumnType::Symbol |        ColumnType::SymbolPool |        ColumnType::I64 |        ColumnType::U64 |        ColumnType::F64 => 8
      },
			file: None
    }
  }
